...
// Stake-meta output types live in a lightweight, dependency-minimal crate so they
// can be consumed from other repos without dragging in this crate's heavy graph.
