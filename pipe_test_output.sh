...
Examples:
    ...
    cargo build-sbf --sbf-out-dir integration_tests/tests/fixtures && SBF_OUT_DIR=integration_tests/tests/fixtures cargo nextest run jito-tip-router-integration-tests::tests tip_router::meta_tests::tests::test_multiple_vaults  |& ./pipe_test_output.sh
EOF
}
