use jito_priority_fee_distribution_sdk::{instruction::claim_ix, jito_priority_fee_distribution};
...
pub fn process_claim_with_payer_priority_fee(
    ...
    if tip_distribution_program
        .key
        .ne(&jito_priority_fee_distribution::ID)
    {
        msg!("Incorrect priority fee distribution program");
