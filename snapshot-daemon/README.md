...
A small Python 3.14 daemon that waits for finalized Solana epoch transitions and creates a full snapshot at the last populated slot of the completed epoch.
